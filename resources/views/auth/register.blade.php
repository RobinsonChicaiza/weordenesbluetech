                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Nombres" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                    name="Nombres" value="{{ old('Nombres') }}" required autofocus onkeypress="return soloLetras(event)">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Ci" type="text" class="form-control{{ $errors->has('Ci') ? ' is-invalid' : '' }}"
                                    name="Ci" value="{{ old('Ci') }}" required autofocus onkeypress="return soloNumeros(event)"
                                    maxlength="10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Ruc" type="text" class="form-control{{ $errors->has('Ruc') ? ' is-invalid' : '' }}"
                                    name="Ruc" value="{{ old('Ruc') }}" required autofocus onkeypress="return soloNumeros(event)"
                                    maxlength="13">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Telefono" type="text" class="form-control{{ $errors->has('Telefono') ? ' is-invalid' : '' }}"
                                    name="Telefono" value="{{ old('Telefono') }}" required autofocus onkeypress="return soloNumeros(event)"
                                    maxlength="10">
