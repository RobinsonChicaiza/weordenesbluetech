                ...
                <div class="card-body">
                    <form class="form-horizontal" method="POST" action="{{ url('/editC',array($cooperativas->Id)) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" onkeypress="return soloLetras(event)" name="Nombre" class="form-control"
                                    id="Nombre" placeholder="Cooperativa" value="<?php echo $cooperativas->Nombre; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" onkeypress="return soloNumeros(event)" name="Ruc" class="form-control"
                                    id="Ruc" placeholder="Ruc" value="<?php echo $cooperativas->Ruc; ?>">
